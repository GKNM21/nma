...
public class JPAClassDAO implements BaseDAO<ScheduledClass> {
    ...
    public List<ScheduledClass> getByCourseCodeAndStartDate(String courseCode, String startDate) {
        TypedQuery<ScheduledClass> query = entityManager.
    ...
    public List<ScheduledClass> getByCourseCodeAndStartDateForStudents(String courseCode, String startDate) {
        TypedQuery<ScheduledClass> query = entityManager.
