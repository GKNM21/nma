...
public class StudentDaoServiceUnitTest {
    ...
    private final String name1 = "Bloke";
    private final String name2 = "Blokess";
    private final String newName = "Karl Jung";
    private final String phoneNumber1 = "290 298 4790";
    private final String phoneNumber2 = "474 939 03 303";
    private final LocalDate dob1 = LocalDate.of(1980, 10, 10);
    private final LocalDate dob2 = LocalDate.of(2000, 5, 5);
    ...
    public void testCreateStudent() {
        ...
        Student newStudent = studentDaoService.createStudent(s);
    ...
    public void testDeleteStudent() {
        ...
        student1.setId(1);
        Student student2 = new Student(name2, phoneNumber2, dob2, Status.FULL_TIME);
        student2.setId(2);
